...
export const BButtonGroup = (props) => {
  ...
  useEffect(() => {
    const activeIndex =
      activeButton > options.length - 1 ? activeButton - 1 : activeButton;
  ...
  return (
    <div style={{ marginBottom: "10px", ...style }}>
      ...
      .bpl-buttonGroupHover-${uniqId}.bpl-button-group-${uniqId}{
        background:${inactiveBg ? inactiveBg : "transparent"};
      }
