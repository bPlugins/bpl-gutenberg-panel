...
export const PanelAlign = (props) => {
  ...
  return (
    <div style={style} className={className}>
      <style>{`
        .single-icon-${id}.single-icon-admin-panel.isActive {
          background-color: ${activeBg};
        }
        .single-icon-${id}.single-icon-admin-panel.hover-color:hover {
          background: ${hoverBg};
        }
        .single-icon-${id}.single-icon-admin-panel.hover-color:hover .single-icon{
          color:${hoverColor};
          fill:${hoverColor};
        }
        .single-icon-${id}.single-icon-admin-panel.isActive .single-icon{
          color:${activeColor};
          fill:${activeColor};
        }
        .single-icon-${id}.single-icon-admin-panel .single-icon i,span,svg{
          height:${iconHeight};
          width:${iconWidth};
        }
          ...
          {options &&
            options.map((icon, i) => (
              <div
                ...
                className={`single-icon-${id} single-icon-admin-panel panelAlign ${value === icon.label.toLowerCase() ? 'isActive' : 'hover-color'
                  }`}
              >
